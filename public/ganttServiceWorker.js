...
//   const projectsURL = (pageNumber = 1, pageSize = 28) =>
// 		`https://dev-portal-api.include.com/includego/tenants/425db690-a10b-4199-b3ef-980be43413df/companies/debf08b8-85c2-4a99-891b-f752caa574f7/projects?&page[number]=${pageNumber}&page[size]=${pageSize}&sort=project_name_lowercase`;
...
// 					console.log(
// 						"🚀 ~ :124 ~ self.addEventListener ~ allProjectsOriginal:",
// 						allProjectsOriginal
// 					);
...
// 						const collapsedProjectIndex = allProjectsOriginal.findIndex(
// 							project => project.id === collapsedProjectId
// 						);

// 						if (collapsedProjectIndex !== -1) {
// 							const collapsedProject = {
// 								...allProjectsOriginal[collapsedProjectIndex],
// 								attributes: {
// 									...allProjectsOriginal[collapsedProjectIndex].attributes,
// 									IsExpanded: false,
// 								},
// 							};

// 							const subsequentProjects = allProjectsOriginal.slice(
// 								collapsedProjectIndex + 1,
// 								collapsedProjectIndex + 1 + 15
// 							);

// 							const finalProjects = [collapsedProject, ...subsequentProjects];

// 							const responsePayload = {
// 								result: finalProjects,
// 								count: meta.total_items,
// 							};
// 							console.log("Collapsing result", responsePayload);
...
// 								const expandingProjectIndex = allProjectsOriginal.findIndex(
// 									project => project.id === parentProjectIdToExpand
// 								);

// 								if (expandingProjectIndex !== -1) {
// 									const expandingProject =
// 										allProjectsOriginal[expandingProjectIndex];
...
// 									// Add at least 15 projects after the expanded project and its tasks
// 									const subsequentProjects = allProjectsOriginal.slice(
// 										expandingProjectIndex + 1,
// 										expandingProjectIndex + 1 + 15
// 									);
// 									finalItems.push(...subsequentProjects);
// 								}
...
// 									count: meta.total_items,
// 								};
// 								console.log("Expanding result", responsePayload);
// 								return new Response(JSON.stringify(responsePayload), {
// 									headers: {
// 										"Content-Type": "application/json",
// 										"Access-Control-Allow-Origin": "*",
